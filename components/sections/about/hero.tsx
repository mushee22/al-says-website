...
export default function HeroSection() {
    return (
        <Container className="max-w-screen relative pt-12 md:pt-24 pb-12.5">
            <Image
                ...
                className="-z-10"
            />
            <div className="container md:pt-24 flex flex-col items-center space-y-7 max-w-[900px] pb-12">
